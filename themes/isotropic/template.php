...
function isotropic_theme() {
  return array(
    #'job_submission_node_form' => array(
    #  'arguments' => array('form' => NULL),
    #  'template' => 'templates/job-submission-node-form',
    #  'render element' => 'form',
    #),
 ...
 * @see page.tpl.php
 */
function isotropic_preprocess_page(&$variables) {
 ...
 * @see layout.tpl.php
 */
function isotropic_preprocess_layout(&$variables) {
 ...
 * @see node.tpl.php
 */
function isotropic_preprocess_node(&$variables) {
 ...
 * @see header.tpl.php
 */
function isotropic_preprocess_header(&$variables) {
  $logo = $variables['logo'];
 ...
 */
function isotropic_breadcrumb($variables) {
