...
<article id="node-<?php print $node->nid; ?>" class="<?php print implode(' ', $classes); ?> clearfix"<?php print backdrop_attributes($attributes); ?>>
  ...
  <div class="content"<?php print backdrop_attributes($content_attributes); ?>>
    <?php
      ...
      //dsm($content['field_analysis_setup']);

      $analysis_setup = $content['field_analysis_setup']['#items'][0]['safe_value'];

      echo '<a target="_blank" href="http://10.0.1.187/files/jobs/' . $title . '/listener.log">Submission Trace</a>';
      echo '<br>';
      echo '<a target="_blank" href="http://10.0.1.187/files/jobs/' . $title . '/'.$title.'.progress">Progress Log</a>';
      echo '<br>';
      echo '<a target="_blank" href="http://10.0.1.187/files/jobs/' . $title . '/'.$content['field_file']['#items'][0]['filename'].'results/">Results Log</a>';
      echo '<br>';
      echo '<br>';
